(() => {
  ...
  function ce(e, t, s) {
    ...
    return (
      a.length ||
        ((a = g(`<div class="swiper-slide-shadow${s ? `-${s}` : ""}"></div>`)),
        n.append(a)),
      a
    );
  }
      ...
      setTranslate: () => {
        ...
        for (let e = 0, t = i.length; e < t; e += 1) {
          const t = i.eq(e),
            ...
            p =
              "function" == typeof a.modifier ? a.modifier(l) : l * a.modifier;
          let u = r ? d * p : 0,
            h = r ? 0 : d * p,
            f = -c * Math.abs(p),
            m = a.stretch;
    ...
    ue(),
      document.querySelector(".swiper") &&
        new te(".swiper", {
          ...
          speed: 400,
          effect: "coverflow",
          coverflowEffect: { rotate: 20, stretch: 50, slideShadows: !0 },
          navigation: {
          ...
          breakpoints: {
            ...
            575: { slidesPerView: 2, spaceBetween: 60 },
